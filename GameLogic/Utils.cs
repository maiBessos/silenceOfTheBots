    ...
    public static class Utils
    {
        ...
        public class DataUnitVec
        {
            ...
            public DataUnitVec()
            {
                ...
                Count = 0;
                Target = EvolutionConstants.targetPoint; 
        ...
        public static HashSet<Evader> getEvadersToRemove(IEnumerable<TaggedEvader> activeEvaders, GameState s, HashSet<Point> O_d, GoEGameParams param)
        {
            ...
            foreach (var e in activeEvaders)
            {
                ...
                if (!s.L[s.MostUpdatedEvadersLocationRound].TryGetValue(e.e, out l))
                    continue;
                
                //if (l.locationType == Location.Type.Node && 
                //    O_d.Contains(l.nodeLocation))
                //    res.Add(e);
                if (l.locationType == Location.Type.Captured)
                    res.Add(e.e);
