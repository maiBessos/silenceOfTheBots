...
namespace SuiteSparseCSWrap
{
    ...
    /// TODO: read more about SuiteSparse project - 
    /// https://fossies.org/linux/SuiteSparse/SPQR/Doc/spqr_user_guide.pdf
    /// it allows matrix operations (includes multiplication etc.) over gpgpu, same implementation as matlab.
    /// the c# wrapper is partial and only allows solving matrices. extending the wrapper can be done
    /// in the project I have here:
    /// C:\Users\Mai\Documents\Bar Ilan\phd\evesSVNwc\GoE\software\MathProgramming\suitesparse-metis-for-windows-master\example-projects\spqr\build
    /// </summary>
    public class Solver
	{
		/// <summary>
