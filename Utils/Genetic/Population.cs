...
/// <summary>
/// Aforge's Population gave me some trouble and wasn't well prepared for inheritance,
/// so this is a dupe that should work with other AForge's classes and we can edit
/// </summary>
namespace GoE.Utils.Genetic
{
    ...
    public class Population
    {
        ...
        protected List<IChromosome> population = new List<IChromosome>();
        protected int size;
        ...
        protected ThreadSafeRandom rand = new ThreadSafeRandom();
        ...
        /// <summary>
        /// invokes SlectionMethod on the population
        /// </summary>
        /// <param name="size"></param>
        protected void applySelection(int size)
        {
        ...
        /// <summary>
        /// inheritor is responsible for adding 'size' evaluated chromosomes 
        /// </summary>
        ...
        /// </remarks>
        /// 
        virtual public void AddChromosome(IChromosome chromosome)
        {
            chromosome.Evaluate(fitnessFunction);
            population.Add(chromosome);
        }
        /// <summary>
        /// allows adding chromosomes into population without exposing the actual population list
        /// </summary>
        /// <param name="chromosome"></param>
        protected void AddChromosomeNoEvaluation(IChromosome chromosome)
        {
            population.Add(chromosome);
        }
        ...
        /// <summary>
        /// Finds best chromosome in the population so far, and updates members
        /// bestChromosome,fitnessMax, fitnessSum, fitnessAvg
        /// </summary>
